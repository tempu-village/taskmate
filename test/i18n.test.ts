...
describe("UI copy boundaries", () => {
  it("keeps Japanese user-facing copy in the Japanese catalog", () => {
    const files = ["domain.ts", "label-picker-modal.ts", "main.ts", "project-modal.ts", "settings.ts", "task-input-suggestions.ts", "task-modal.ts", "view.ts"];
  ...
  it("rejects new literal copy at known rendering seams", () => {
    const files = ["label-picker-modal.ts", "main.ts", "project-modal.ts", "settings.ts", "task-modal.ts", "view.ts"];
